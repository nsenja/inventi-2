    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="card-body">
                    <form action="{{ route('barang-masuk.cetak') }}" method="GET" target="_blank" class="mb-4">
                    ...
                    <div class="table-responsive">
                        <table id="barangMasukTable" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center">Data barang masuk belum ada.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
